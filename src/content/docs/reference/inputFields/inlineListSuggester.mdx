...
Clicking the plus button at the end of the list will open a suggester modal similar to the <InputFieldLink type={InputFieldType.LIST_SUGGESTER}></InputFieldLink> with which you can add a new element to the list.
