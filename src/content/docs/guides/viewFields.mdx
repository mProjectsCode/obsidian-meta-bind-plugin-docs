...
The plugin also offers the ability to create view fields with JavaScript from inside your notes.
You can activate this feature in the plugins settings.
By default, js view fields are disabled, as they can pose a security risk.

You need JS Engine installed and enabled for JS View Fields to work.

Js view fields consist of two sections.
First the bind target section and then the JS section.
When rendered, the JS view field displays the value returned in the JS section just as JS Engine would.
