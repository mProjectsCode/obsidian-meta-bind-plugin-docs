...
The plugin will move to [JS Engine](https://github.com/mProjectsCode/obsidian-js-engine-plugin) for running JS View Fields in the next release.
This will allow you to do more interesting things with view fields, but this also causes the available global variables to change.
